...
RSpec.configure do |config|
  ...
  config.global_fixtures = :accounts, :client_applications, :conversations, :feeds, :forums, :neighborhoods, :oauth_nonces, :oauth_tokens, :offers, :people, :posts, :preferences, :topics, :memberships

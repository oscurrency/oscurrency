...
ActiveRecord::Schema.define(version: 20180322113046) do
  ...
  add_index "categories_offers", ["offer_id", "category_id"], name: "index_categories_offers_on_offer_id_and_category_id", using: :btree
  ...
  add_index "categories_people", ["person_id", "category_id"], name: "index_categories_people_on_person_id_and_category_id", using: :btree
  ...
  add_index "categories_reqs", ["category_id"], name: "index_categories_reqs_on_category_id", using: :btree
  add_index "categories_reqs", ["req_id", "category_id"], name: "index_categories_reqs_on_req_id_and_category_id", using: :btree
  ...
  add_index "communications", ["conversation_id"], name: "index_communications_on_conversation_id", using: :btree
  add_index "communications", ["recipient_id"], name: "index_communications_on_recipient_id", using: :btree
  add_index "communications", ["sender_id"], name: "index_communications_on_sender_id", using: :btree
  add_index "communications", ["type"], name: "index_communications_on_type", using: :btree
  ...
  add_index "connections", ["person_id", "contact_id"], name: "index_connections_on_person_id_and_contact_id", using: :btree
  ...
  add_index "email_verifications", ["code"], name: "index_email_verifications_on_code", using: :btree
  ...
  add_index "feeds", ["person_id", "activity_id"], name: "index_feeds_on_person_id_and_activity_id", using: :btree
  ...
  add_index "fees", ["fee_plan_id"], name: "index_fees_on_fee_plan_id", using: :btree
  ...
  add_index "neighborhoods_offers", ["neighborhood_id"], name: "index_neighborhoods_offers_on_neighborhood_id", using: :btree
  add_index "neighborhoods_offers", ["offer_id", "neighborhood_id"], name: "index_neighborhoods_offers_on_offer_id_and_neighborhood_id", using: :btree
  ...
  add_index "neighborhoods_people", ["neighborhood_id"], name: "index_neighborhoods_people_on_neighborhood_id", using: :btree
  add_index "neighborhoods_people", ["person_id", "neighborhood_id"], name: "index_neighborhoods_people_on_person_id_and_neighborhood_id", using: :btree
  ...
  add_index "neighborhoods_reqs", ["neighborhood_id"], name: "index_neighborhoods_reqs_on_neighborhood_id", using: :btree
  add_index "neighborhoods_reqs", ["req_id", "neighborhood_id"], name: "index_neighborhoods_reqs_on_req_id_and_neighborhood_id", using: :btree
  ...
  add_index "people", ["admin"], name: "index_people_on_admin", using: :btree
  add_index "people", ["business_name"], name: "index_people_on_business_name", using: :btree
  add_index "people", ["deactivated"], name: "index_people_on_deactivated", using: :btree
  ...
  add_index "stripe_fees", ["fee_plan_id"], name: "index_stripe_fees_on_fee_plan_id", using: :btree

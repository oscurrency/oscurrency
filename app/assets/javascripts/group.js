...
$(function() {
  ...
  $('.edit_member_preference, #new_bid, .edit_bid, #edit_req, #new_offer, #edit_offer, #new_topic, #new_post, #new_exchange, #new_wall_post, #tabs #new_message').live('submit',function() {
